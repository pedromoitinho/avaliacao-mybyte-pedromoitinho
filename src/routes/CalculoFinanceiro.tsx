...
import "../styles/CalculoFinanceiro.css"
import "../styles/global.css"
import { calculoJurosSimples, calculoMontante } from "../functions/calculoFinanceiroFunction"

export default function CalculoFinanceiro(){
	...
	const handleCalculate = (e: React.FormEvent) => {
		...
		if (capital > 0 && taxa > 0 && tempo > 0) {
			const jurosCalculados = calculoJurosSimples(capital, taxa / 100, tempo);
			const montanteCalculado = calculoMontante(capital, jurosCalculados);			
	...
	return(
		<div className="calculoPage">
			<div className="calculoCard">
				<h2>Calculadora de Juros Simples</h2>
				<form className="calculoForm" onSubmit={handleCalculate}>
					<div className="field">
					...
					<div className="buttonContainer">
						<button className="calculoButton" type="submit">Calcular</button>
